...
import Add from "@/Components/Academics/Period/Add";
import List from "@/Components/Academics/Period/List";
...
import { GET_PERIOD_LIST } from "@/Urql/Query/Academics/period.query";
...
const Section = () => {
    ...
    return (
        <Layout main="academics" sub="period" title="Period">
            <PageHeader
                title="Academics"
                navs={["Dashboard", "Academics", "Period"]}
            />
