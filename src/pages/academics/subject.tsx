...
import Add from "@/Components/Academics/Subject/Add";
import List from "@/Components/Academics/Subject/List";
...
import { GET_SUBJECT_LIST } from "@/Urql/Query/Academics/subject.query";
...
const Subject = () => {
    ...
    return (
        <Layout main="academics" sub="subject" title="Subject">
            <PageHeader
                title="Academics"
                navs={["Dashboard", "Academics", "Subject"]}
            />
