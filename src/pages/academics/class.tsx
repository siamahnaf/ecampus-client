...
import Add from "@/Components/Academics/Class/Add";
import List from "@/Components/Academics/Class/List";
...
import { GET_CLASS_LIST } from "@/Urql/Query/Academics/class.query";
...
const ClassPage = () => {
    ...
    return (
        <Layout main="academics" sub="class" title="Class">
            <PageHeader
                title="Academics"
                navs={["Dashboard", "Academics", "Class"]}
            />
