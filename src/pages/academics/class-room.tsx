...
import Add from "@/Components/Academics/Room/Add";
import List from "@/Components/Academics/Room/List";
...
import { GET_ROOM_LIST } from "@/Urql/Query/Academics/room.query";
...
const Room = () => {
    ...
    return (
        <Layout main="academics" sub="classRoom" title="Class Room">
            <PageHeader
                title="Academics"
                navs={["Dashboard", "Academics", "Class Room"]}
            />
