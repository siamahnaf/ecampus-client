...
import Add from "@/Components/Communication/Notification/Add";
...
const AddNotification = () => {
    return (
        <Layout main="communication" sub="notification" title="Notification">
            <PageHeader
                title="Notification"
                navs={["Dashboard", "Communication", "Notification"]}
            />
            <Add />
        </Layout >
    );
