...
import Lists from "@/Components/Communication/NotificationList/Lists";
...
const NotificationList = () => {
    ...
    return (
        <Layout main="communication" sub="notificationList" title="Notification">
            <PageHeader
                title="Notification List"
                navs={["Dashboard", "Communication", "Notification List"]}
            />
