...
const Confirm = ({ open, onClose, onConfirm, fetching, id }: Props) => {
    return (
        <Dialog
            open={open}
            handler={onClose}
        ...
        >
            <DialogBody className="text-black text-center py-8">
                <Icon className="text-7xl inline text-red-600" icon="mdi:delete-empty" />
                <Typography variant="h5" className="mt-2 mb-2 text-red-600">Delete?</Typography>
