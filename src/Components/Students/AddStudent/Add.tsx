...
import { ADD_STUDENT, GET_STUDENT_LIST, GET_ALL_STUDENT } from "@/Urql/Query/Students/student.query";
import { AddStudentData, GetStudentListData, GetAllStudentData } from "@/Urql/Types/Students/student.types";
...
const Add = () => {
    ...
    const [{ data, error, fetching }, addStudent] = useMutation<AddStudentData>(ADD_STUDENT);
    ...
    const onSubmit: SubmitHandler<Inputs> = (value) => {
        ...
        addStudent({ studentInput: studentData }).then(() => {
    ...
    return (
        <div className="pb-5">
            {(error || data) &&
                ...
                >
                    {error?.message ?? data?.addStudent.message}
                </Notification>
            }
            <h3 className="text-base font-semibold mb-5">Add Student</h3>
