...
import { ADD_SECTION, GET_SECTION_LIST, GET_ALL_SECTIONS } from "@/Urql/Query/Academics/section.query";
import { AddSectionData, GetSectionListData, GetAllSectionData } from "@/Urql/Types/Academics/section.types";
...
const Add = () => {
    ...
    //Urql
    const [{ data, error, fetching }, addList] = useMutation<AddSectionData>(ADD_SECTION);
    ...
    const onSubmit: SubmitHandler<Inputs> = (value) => {
        addList({ sectionInput: value }).then(({ data }) => {
