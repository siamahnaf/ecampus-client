    ...
    return (
        ...
        >
            <DialogBody className="text-textColor">
                ...
                {defaultValue.image &&
                    <Image src={process.env.NEXT_PUBLIC_IMAGE_URL + defaultValue.image} alt={defaultValue.title} width={800} height={300} className="rounded-lg aspect-[16/6] object-cover object-center" />
                }
